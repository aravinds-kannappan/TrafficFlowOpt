...
class NetworkManager {
    ...
    initializeMap() {
        ...
        // Initialize Leaflet map centered on Austin/Chicago area
        this.map = L.map('network-map').setView([35.2271, -92.5], 6);
    ...
    createSampleNetwork() {
        ...
        // Austin and Chicago intersections
        const sampleNodes = [
            { id: 'n1', name: 'Grove Blvd & Riverside Dr', lat: 30.2672, lon: -97.7431, status: 'normal' },
            { id: 'n2', name: 'Congress Ave & Oltorf St', lat: 30.2500, lon: -97.7594, status: 'normal' },
            { id: 'n3', name: '6th St & Red River St', lat: 30.2655, lon: -97.7345, status: 'warning' },
            { id: 'n4', name: 'Michigan Ave & Madison St', lat: 41.8819, lon: -87.6278, status: 'warning' },
            { id: 'n5', name: 'State St & Jackson Blvd', lat: 41.8776, lon: -87.6270, status: 'normal' }
        ];
